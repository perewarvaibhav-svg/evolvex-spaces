...
async function initDb() {
  ...
  `);
    ...
    if (count === 0) {
        ...
        if (lakshmi) {
            await execute(`INSERT INTO wins(user_id,title,description,featured,created_at) VALUES(?,?,?,?,?)`, [lakshmi.id, 'Lakshmi — Student of the Week', 'Moved from idea to prototype.', 1, nowIso()]);
        }
    }
}
