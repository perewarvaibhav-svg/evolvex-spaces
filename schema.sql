-- ============================================================
--  EvolveX — Supabase Schema & RPC Helpers  (COMPLETE v2)
...
-- ─── Sessions (Journey page - admin managed) ───────────────
CREATE TABLE IF NOT EXISTS sessions_data (
  ...
  linkedin    TEXT DEFAULT '',
  event_date  TEXT NOT NULL,
  event_type  TEXT DEFAULT 'Saturday Session',
...
-- ─── Access Requests (with role + password support) ────────
...
ALTER TABLE sessions_data          DISABLE ROW LEVEL SECURITY;
